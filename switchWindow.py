...
class Window(QWidget):
    ...
    def convert_final(self, image):
        ...
        for n in range(len(contours)):
            ...
            areaCell = [x for x in area if x > thres_cell]
        ...
        for n in range(len(contourspanel)):
            ...
            areaPanel = [x for x in areap if x > thres_panel]
    ...
    def maxArea(self, image):
            ...
            defect = (luas_hotspot / luas_panel) * 100
            print("%Defect (min): ", defect)
            print("Luas Panel2 (min): ", areaPanel)
            print("Luas HotSpot2 (min): ", areaCell)
